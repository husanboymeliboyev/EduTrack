...
namespace EduTrack.Migrations
{
    ...
    [Migration("20260816142746_AddPerformanceCriteria")]
    partial class AddPerformanceCriteria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduTrack.Models.GradeComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("GradeComponents", t =>
                        {
                            t.HasCheckConstraint("CK_GradeComponent_SingleLink", "AssignmentId IS NULL OR ExamId IS NULL");
                        });
                });
            ...
            modelBuilder.Entity("EduTrack.Models.QuestionBank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EduTrack.Models.StudentGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EduTrack.Models.Exam", b =>
                {
                    ...
                    b.HasOne("EduTrack.Models.QuestionBank", "QuestionBank")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("EduTrack.Models.StudentGrade", b =>
                {
                    b.HasOne("EduTrack.Models.GradeComponent", "GradeComponent")
                        .WithMany("Grades")
