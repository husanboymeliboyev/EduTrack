...
namespace EduTrack.Migrations
{
    ...
    public partial class ChangeAttendanceToStatusEnum : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE Attendances SET Status = CASE WHEN Status = 1 THEN 0 ELSE 1 END");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE Attendances SET Status = CASE WHEN Status = 0 THEN 1 ELSE 0 END");
